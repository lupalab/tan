...
Has commented out lines from source above that lead to different dataset
than what was used in MAF paper.
"""
import numpy as np
...
def download_and_make_data(datapath):
    ...
    path = os.path.join(datapath, 'miniboone_noprune/')
    misc.make_path(path)
    print('Downloading...')
    ...
    print('Saving...')
    outfile = os.path.join(path, 'miniboone_noprune.p')
    pickle.dump(
